DOMAIN_SUMMARY = 'A practical Finance Review Evidence Review Simple RAG - Beginner Custom 2 assistant tailored for Simple RAG workflows.'
USER_PERSONA = 'Operations user who needs source-grounded answers, checklists, and clear next actions.'
STARTER_QUESTIONS = ['What should I know first about Finance Review Evidence Review Simple RAG - Beginner Custom 2?', 'What policy or evidence supports the recommended next step?', 'Create a checklist for handling this request.']
